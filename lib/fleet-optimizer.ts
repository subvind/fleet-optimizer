      ...
      order(orderId: number) {
        ...
        return {
          add() {
            ...
            return that.fleet(fleetId).order(orderId)
          },
      ...
      customer(customerId: string) {
        return {
          add() {
            ...
            return that.fleet(fleetId).customer(customerId)
          }
        }
      },
      contact(first: string, last: string) {
        return {
          add() {
            ...
            return that.fleet(fleetId).contact(first, last)
          },
          customerId(id: string) {
      ...
      location(locationId: string) {
        return {
          add() {
            ...
            return that.fleet(fleetId).location(locationId)
          },
          customerId(id: string) {
